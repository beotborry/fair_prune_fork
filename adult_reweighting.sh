...
do
    ...
    do
        ...
        do
            ...
            python3 main.py --device 1 --dataset adult --sen-attr sex --lr $lr --epoch 5 --batch-size 128 --seed $seed --method reweighting --optimizer Adam --model mlp --reweighting-target-criterion eo --img-size 98 --eta $eta --weight-decay 0.0005 --iteration 10 --date 20220211
        done
    done
done
