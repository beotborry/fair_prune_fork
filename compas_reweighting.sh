...
do
    ...
    do
        ...
        do
            python3 main.py --device 1 --dataset compas --sen-attr sex --lr $lr --epoch 5 --batch-size 128 --seed $seed --method reweighting --optimizer Adam --model mlp --reweighting-target-criterion eopp --img-size 401 --eta $eta --weight-decay 0.0005 --iteration 10 --date 20220214
